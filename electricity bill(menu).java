...
abstract class EleBoard
{
	...
	abstract void fxdcharges_display1();
	abstract void fxdcharges_display2();
	abstract void unit_display();
	abstract void FAC_display1();
	abstract void FAC_display2();
...
class FixedCharge extends ConsumptionDetails
{
	...
	void fxdcharges_display2()
	{
		System.out.println("Fixed Charges (Unit, Rate, Amount)");
		System.out.println("1KW\t52\t52.00");
		System.out.println("1KW\t63\t63.00");
		System.out.println("--------------------------------------------------");
		System.out.println("Energy Charges (Unit, Rate, Amount)");
	}
	void unit_display()
...
class Addition extends FixedCharge
{
	...
	void net2()
	{
		BillAmt =  52 + 63+ amt + (units*0.2) + tax;
		System.out.println("Bill Amt:           \t"+BillAmt);
		System.out.println("Arrears             \t"+Arrears);
		System.out.println("credits & Adjustment\t"+cred);
		System.out.println("GOK Subsidy:        \t"+subsidy);
		...
		net=52 + 63 + amt + (units*0.2) + tax + rebate + penalty + intrest + others +  Arrears +  cred + subsidy ;
		System.out.print("Net Amt Due           \tRs.");
		System.out.println(Math.round(+net));
	}
	...
	public static void main(String args[]) 
	{
		...
		Scanner s8=new Scanner(System.in);
		{
			...
			if(choice==1)
			{
				...
				System.out.println("Due Date    \t"+Da);
...
--------------------------------------------------
Billing Details
Bill Period   	24-07-2020 : 24-08-2020
Billing Date: 	2020-08-24
Bill No:0.5877790402347536
--------------------------------------------------
Consumption Details
Prev. Rdng:	6673
Pres. Rdng:	6597
